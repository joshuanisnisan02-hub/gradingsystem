      ...
      Expanded(child: Container(
        ...
        child: SingleChildScrollView(padding: const EdgeInsets.all(26), child: ConstrainedBox(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            const Text('Use the account issued by your administrator.', style: TextStyle(color: SmartGradeColors.muted)),
            ...
            const Text('Need an account? Ask your SmartGrade administrator.', textAlign: TextAlign.center, style: TextStyle(color: SmartGradeColors.muted, fontSize: 11, height: 1.45)),
          ]),
        )),
      )),
    ]),
