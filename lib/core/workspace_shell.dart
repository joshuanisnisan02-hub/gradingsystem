...
class _IconRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: SafeArea(child: Column(children: [
      ...
      const _RailButton(icon: Icons.people_alt_outlined, route: '/students', tooltip: 'Students'),
      const _RailButton(icon: Icons.cloud_sync_outlined, route: '/imports', tooltip: 'Imports & Sync'),
